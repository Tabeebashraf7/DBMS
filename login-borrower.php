<?php      
    ...
    $password = $_POST['pass'];  
        ...
        $sql = "select * from borrower where borrower_name = '$username' AND pass_word = '$password'";  
  ...
  <div class="container full-height-grow">
    ...
    <section class="join-main-section">
      ...
      Log in as a
       ...
       <form class="join-form" name="f1" action = "login-borrower.php" onsubmit = "return validation()" method = "POST">
