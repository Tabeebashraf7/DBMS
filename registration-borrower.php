    ...
    <section class="join-main-section">
      ...
      <form class="join-form" action="registration-borrower.php" method="post">
        <div class="input-group">
          <label for="subid">Borrower Name</label>
          <input type="value" name="name" id="name" required>
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          <label for="pnumber">Subject Id</label>
          <input type="value" name="subid" id="subid" required>
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          <button type="submit" class="btn" ><a href="data1.php">check your lender id</a></button>
          </div>
      </form>
