...
$sql = "UPDATE `lender` SET `lender_name` = '$pass' WHERE `lender_name` = '$user'";
...
<body class="full-height-grow">
  <div class="container full-height-grow">
    ...
    <section class="join-main-section">
      <h1 class="join-text">
      Update the
        <span class="accent-text">Lender data</span>
      </h1>


      <form class="join-form" name="f1" action = "update-lender.php" method = "POST">
